...
CREATE TABLE "BILL" 
   (	"BILLID" NUMBER(10) default billSequence.nextVal NOT NULL, 
	...
	"INSURANCEPATIENTID" NUMBER(*,0)NOT NULL,
    CONSTRAINT "BILL_PK" PRIMARY KEY ("BILLID", "PATIENTID") 
   )';
execute immediate v_sql;
...
CREATE TABLE "EMPLOYEE" 
   (	"EMP_ID" NUMBER(10) default employeeSequence.nextVal NOT NULL, 
    ...
    CONSTRAINT "EMPLOYEE_PK" PRIMARY KEY ("EMP_ID", "ROLE_ID")
   )';
execute immediate v_sql;
...
v_sql:='
   ...
   (	"INSURANCECODE" NUMBER(10) default insurancemasterSequence.nextVal NOT NULL, 
	"PATIENTID" VARCHAR2(40)NOT NULL, 
...
v_sql:='
   ...
   (	"LABNUMBER" NUMBER(10) default labSequence.nextVal NOT NULL, 
    ...
    CONSTRAINT "LAB_PK" PRIMARY KEY ("LABNUMBER", "PATIENTID")
   )';
execute immediate v_sql;
...
v_sql:='
   ...
   (	"PATIENT_ID" NUMBER(10) default patientSequence.nextVal NOT NULL, 
